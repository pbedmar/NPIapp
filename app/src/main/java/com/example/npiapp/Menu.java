...
public class Menu {
    ...
    private int price_first1;
    private int ordered_first1;

    @NonNull
    private String first2;
    private int price_first2;
    private int ordered_first2;

    @NonNull
    private String main1;
    private int price_main1;
    private int ordered_main1;

    @NonNull
    private String main2;
    private int price_main2;
    private int ordered_main2;

    @NonNull
    private String dessert1;
    private int price_dessert1;
    private int ordered_dessert1;

    @NonNull
    private String dessert2;
    private int price_dessert2;
    private int ordered_dessert2;

    private int day_with_order;


    public Menu(@NonNull String date, String first1, int price_first1, int ordered_first1, String first2, int price_first2, int ordered_first2, String main1, int price_main1, int ordered_main1, String main2, int price_main2, int ordered_main2, String dessert1, int price_dessert1, int ordered_dessert1, String dessert2, int price_dessert2, int ordered_dessert2, int day_with_order) {
        this.date = date;
        this.first1 = first1;
